...
class App extends BaseConfig
{
    ...
    |
    */
    // public $baseURL = 'http://192.168.3.53/hg/';
     public $baseURL = 'http://localhost/hg/';
    ...
    */
    public $CSRFTokenName  = 'devx_token';
    public $CSRFHeaderName = 'X-CSRF-TOKEN';
    public $CSRFCookieName = 'devx_cookie';
