<div class="navbar navbar-dark navbar-expand-lg navbar-static border-bottom border-bottom-white border-opacity-10">
    <div class="container-fluid">
        ...
        <div class="navbar-brand flex-1 flex-lg-0">
            <a href="<?= base_url(route_to('admin_dashboard')); ?>" class="d-inline-flex align-items-center">
                <img src="<?php echo base_url('public/admin/assets/images/agir-logo.png') ?>" alt="" height="250px">
        ...
        <ul class="nav flex-row">
            ...
            <li class="nav-item nav-item-dropdown-lg dropdown ms-lg-2">
                <a href="#" class="navbar-nav-link navbar-nav-link-icon rounded-pill" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                    <i class="ph-chats"></i>
                    <span class="badge bg-yellow text-black position-absolute top-0 end-0 translate-middle-top zindex-1 rounded-pill mt-1 me-1"><?php /*= $say */?></span>
                </a>
                ...
                <div class="dropdown-menu wmin-lg-400 p-0">
                   ...
                   <!-- <?php /*while ($row2 = oci_fetch_array($mesaj, OCI_BOTH + OCI_RETURN_LOBS + OCI_RETURN_NULLS)) { */?>

                        <a href="#" class="dropdown-item align-items-start text-wrap py-2">
                            <div class="status-indicator-container me-3">
                                <img src="<?php /*= base_url('public/admin/assets/images/demo/users/face10.jpg'); */?>" class="w-40px h-40px rounded-pill" alt="">
                                <span class="status-indicator bg-warning"></span>
                            </div>

                            <div class="flex-1">
                                <span class="fw-semibold"><?php /*= $row2['TARIH'] */?></span>
                                <span class="text-muted float-end fs-sm"></span>
                                <div class="text-muted"><?php /*= $row2['MESAJ'] */?></div>
                            </div>
                        </a>
            ...
            <li class="nav-item nav-item-dropdown-lg dropdown ms-lg-2">
                <a href="#" class="navbar-nav-link align-items-center rounded-pill p-1" data-bs-toggle="dropdown">
                    <div class="status-indicator-container">
                        ...
                        { ?>
                        <img src="<?= base_url('public/admin/assets/images/bugrabey.jpg'); ?>" class="w-32px h-32px rounded-pill" alt="">
                        <?php } else { ?>
                            <img src="<?= base_url('public/admin/assets/images/fav.png'); ?>" class="w-32px h-32px rounded-pill" alt="">
                        <?php } ?>
                        <span class="status-indicator bg-success"></span>
                    </div>
                    <span class="d-none d-lg-inline-block mx-lg-2"><?= session('userData.name') ?></span>
                </a>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="#" class="dropdown-item">
                        ...
                        <?= lang('Navbar.text.account_setting') ?>
                    </a>
                    <a href="<?php echo base_url(route_to('admin_logout')) ?>" class="dropdown-item">
