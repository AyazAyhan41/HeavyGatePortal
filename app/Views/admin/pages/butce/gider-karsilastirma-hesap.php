...
Gider Bütcesi - Hesap Bazında Gider Karşılaştırma
<?php $this->endSection() ?>
    ...
    <div class="page-header-content d-lg-flex">
        <div class="d-flex">
            <h4 class="page-title mb-0">
                Gider Bütçesi - <span class="fw-normal">Hesap Bazında Gider Karşılaştırma</span>
            </h4>
    ...
    <div class="page-header-content d-lg-flex border-top">
        <div class="d-flex">
            <div class="breadcrumb py-2">
                ...
                <span class="breadcrumb-item active">Hesap Bazında Gider Karşılaştırma</span>
            </div>
...
<div class="content">
    ...
    <div class="card">
        <div class="card-header d-flex flex-wrap">
            <h5 class="mb-0">Hesap Bazında Gider Karşılaştırma</h5>
