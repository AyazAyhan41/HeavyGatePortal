            ...
            while ($row = oci_fetch_array($veri, OCI_BOTH)) {
                ...
                <tr>
                    ...
                    <td class="text-end"><?php
                        $fmt = numfmt_create('', NumberFormatter::CURRENCY);
                        $topla =
                    ...
                    <td class="text-end"><?= "€" . number_format((float)$row['OCAK_TUTAR'], 2) ?></td>
                    <td class="text-end"><?= "€" . number_format((float)$row['SUBAT_TUTAR'], 2); ?></td>
                    <td class="text-end"><?= "€" . number_format((float)$row['MART_TUTAR'], 2); ?></td>
                    <td class="text-end"><?= "€" . number_format((float)$row['NISAN_TUTAR'], 2); ?></td>
                    <td class="text-end"><?= "€" . number_format((float)$row['MAYIS_TUTAR'], 2); ?></td>
                    <td class="text-end"><?= "€" . number_format((float)$row['HAZIRAN_TUTAR'], 2); ?></td>
                    <td class="text-end"><?= "€" . number_format((float)$row['TEMMUZ_TUTAR'], 2); ?></td>
                    <td class="text-end"><?= "€" . number_format((float)$row['AGUSTOS_TUTAR'], 2); ?></td>
                    <td class="text-end"><?= "€" . number_format((float)$row['EYLUL_TUTAR'], 2); ?></td>
                    <td class="text-end"><?= "€" . number_format((float)$row['EKIM_TUTAR'], 2); ?></td>
                    <td class="text-end"><?= "€" . number_format((float)$row['KASIM_TUTAR'], 2); ?></td>
                    <td class="text-end"><?= "€" . number_format((float)$row['ARALIK_TUTAR'], 2); ?></td>
