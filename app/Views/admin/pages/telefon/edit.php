        ...
        <div class="card-body">
            <form action="<?= current_url() ?>" method="post">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control" value="<?= $telefon->getFirstName(); ?>" name="first_name" placeholder="Adı">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control" value="<?= $telefon->getSurName(); ?>"  name="sur_name" placeholder="Soyadı">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control" value="<?= $telefon->getPhone(); ?>" name="phone" maxlength="4" placeholder="Telefon">
                    </div>
                </div>
