    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Kullanıcı Listesi</h4>
                    ...
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-sm-auto ms-auto">
                            <div class="hstack gap-2">
                                <a href="#" class="btn btn-primary add-btn"><i class="ri-add-line align-bottom me-1"></i> Yeni Kullanıcı Ekle</a>
                ...
                <div class="card-body">
                    <div>
                        <div class="table-responsive table-card">
                            <table class="table table-nowrap align-middle custom-table" id="customerTable">
                                ...
                                <tr>
                                    ...
                                    <th class="sort" data-sort="name">Mustafa</th>
                                    <th class="sort" data-sort="name">Mustafa</th>
                                    <th class="sort" data-sort="name">Mustafa</th>
                                    <th class="sort" data-sort="name">Mustafa</th>
                                ...
                                <?php foreach ($users as $key =>$user): ?>
                                    <tr>
                                        ...
                                        <td class="company_name"><?=  $user->getFirstName() ?></td>
                                        <td class="company_name"><?=  $user->getFirstName() ?></td>
                                        <td class="company_name"><?=  $user->getFirstName() ?></td>
                                        <td class="company_name"><?=  $user->getFirstName() ?></td>
                                        <td class="company_name"><?=  $user->getFirstName() ?></td>
                                        <td class="leads_score"><?=  $user->getCreatedAt(true) ?></td>
                                ...
                                <div class="modal-body p-5 text-center">
                                    ...
                                    <div class="mt-4 text-center">
                                        ...
                                        <div class="hstack gap-2 justify-content-center remove">
                                            <button class="btn btn-link link-info fw-semibold text-decoration-none" data-bs-dismiss="modal"><i class="ri-close-line me-1 align-middle"></i> Close</button>
...
<?= script_tag('public/admin/assets/js/pages/user-listing.init.js') ?>
