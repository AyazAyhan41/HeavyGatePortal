                        ...
                        <div class="table-responsive table-card mb-1">
                            <table class="table table-nowrap align-middle" id="groupTable">
                                ...
                                <tr class="text-uppercase">
                                    ...
                                    <th>Satiş Miktari</th>
                                    <th>Satiş ÖB</th>
                                    <th>Sipariş Tonajı</th>
                                    <th>Sevk Edilen Tonaj</th>
                                    <th>Sip. Açık Tonaj</th>
                                </tr>
                                </thead>
                                ...
                                <tr>
                                    ...
                                    <td><?= $row['LINE_NO'] ?></td>
                                    <td><?= $row['REL_NO'] ?></td>
                                    <td><?= $row['SİPARİŞ_TÜRÜ'] ?></td>
                                    <td><?= $row['CUSTOMER_NO'] ?></td>
                                    <td><?= $row['MÜŞTERİ_ADI'] ?></td>
                                    <td><?= $row['TÜR'] ?></td>
                                    <td><?= $row['İSTENEN_MİKTAR'] ?></td>
                                    <td><?= $row['SATIŞ_MİKTARI'] ?></td>
                                    <td><?= $row['SATIŞ_ÖB'] ?></td>
                                    <td><?= $row['AĞIRLIK'] ?></td>
                                    <td><?= $row['REZERVE_MİKTAR'] ?></td>
