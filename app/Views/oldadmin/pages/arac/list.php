                        ...
                        <div class="table-responsive table-card mb-1">
                            <table class="table table-nowrap align-middle" id="groupTable">
                                ...
                                <tr class="text-uppercase">
                                    <th class="sort" data-sort="id">Kayıt Id</th>
                                    <th class="sort" data-sort="customer_name">Kayıt Tipi</th>
                                    <th class="sort" data-sort="product_name">Plaka</th>
                                    <th class="sort" data-sort="date">Sürücü Adı</th>
                                    <th class="sort" data-sort="city">Varış Tarihi</th>
                                    <th class="sort" data-sort="city">Giriş Tarih</th>
                                    <th class="sort" data-sort="city">Takoz Adet</th>
                                    <th class="sort" data-sort="city">İhtiyaç Takoz Adet</th>
                                    <th class="sort" data-sort="city">Verilen Takoz Adet</th>
                                    <th class="sort" data-sort="city">Müşteri Adı</th>
                                    <th class="sort" data-sort="city">Lokasyon</th>
                                ...
                                <tr>
                                    ...
                                    <td class="id"><?=  $row['KAYITID']; ?></td>
                                    <td class="product_name"><?=  $row['KAYITTIPI']; ?></td>
                                    <td class="date"><?=  $row['PLAKA']; ?></td>
                                    <td class="date"><?=  $row['DRIVER']; ?></td>
                                    <td class="date"><?php if ( $row['FABRIKA_GIRIS'] == '01/01/0001' ) { ?>
                                    <?php } else { ?>
                                    <?= $row['FABRIKA_GIRIS'] ?>
                                    <?php } ?>
                                    </td>

                                    <td class="date"><?php if ( $row['FABCIKISTARIH'] == '01/01/0001' ) { ?>
                                        <?php } else { ?>
                                            <?= $row['FABCIKISTARIH'] ?>
                                        <?php } ?>
                                    </td>
