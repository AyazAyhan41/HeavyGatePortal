    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Raporlama Özet</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Yönetim Paneli</a></li>
                        <li class="breadcrumb-item active">Raporlama Özet</li>
                    </ol>
                </div>
            ...
            <div class="h-100">
                    ...
                    <div class="col-12">
                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                            <div class="flex-grow-1">
                                <h4 class="fs-16 mb-1">Hoşgeldiniz, <?= session('userData.name') ?>!</h4>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 overflow-hidden">
                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0"> Toplam Kazanç</p>
                                    </div>
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        ...
                                        <a href="" class="text-decoration-underline">Detaylı Bilgi</a>
                                    </div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 overflow-hidden">
                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Siparişler</p>
                                    </div>
                                    <div class="flex-shrink-0">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        ...
                                        <a href="" class="text-decoration-underline">Tüm Satışlar</a>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                    ...
                    <div class="col-xl-3 col-md-6">
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 overflow-hidden">
                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0"> Toplam Kasa</p>
                                    </div>
                                    <div class="flex-shrink-0">
                    ...
                    <div class="col-xl-8">
                        <div class="card">
                            <div class="card-header border-0 align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">Hasılatlar</h4>
                                <div>
                                ...
                                <div class="row g-0 text-center">
                                    <div class="col-6 col-sm-3">
                                        <div class="p-3 border border-dashed border-start-0">
                                            ...
                                            <p class="text-muted mb-0">Siparişler</p>
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-6 col-sm-3">
                                    ...
                                    <div class="col-6 col-sm-3">
                                        <div class="p-3 border border-dashed border-start-0">
                                            ...
                                            <p class="text-muted mb-0">Ödemeler</p>
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-6 col-sm-3">
                                        <div class="p-3 border border-dashed border-start-0 border-end-0">
                                            ...
                                            <p class="text-muted mb-0">Dönşüm Oranı</p>
                                        </div>
                                    </div>
                                    <!--end col-->
                                </div>
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card card-height-100">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">Lokasyon Bazlı Satış</h4>
                                <div class="flex-shrink-0">
                                    <button type="button" class="btn btn-soft-primary btn-sm">
                                        Export Report
                                    </button>
                            ...
                            <div class="card-body">
                                ...
                                <div id="sales-by-locations" data-colors='["--vz-light", "--vz-info", "--vz-primary"]' style="height: 269px" dir="ltr"></div>
                ...
                <div class="row">
                   <div class="col-xl-12">
                        <div class="card card-height-100">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">Firma Bazlı Saışlar</h4>
                                <div class="flex-shrink-0">
                                    <div class="dropdown card-header-dropdown">
                                        <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <span class="text-muted">Rapor<i class="mdi mdi-chevron-down ms-1"></i></span>
                                        </a>
                                    ...
                                    <table class="table table-centered table-hover align-middle table-nowrap mb-0">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="<?php echo base_url('public/admin/assets/images/companies/img-1.png') ?>" alt="" class="avatar-sm p-2" />
                                                    </div>
                                                    <div>
                                                        <h5 class="fs-14 my-1 fw-medium">
                                                            <a href="apps-ecommerce-seller-details.html" class="text-reset">Ağır Haddecilik</a>
                                                        </h5>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="<?php echo base_url('public/admin/assets/images/companies/img-2.png') ?>" alt="" class="avatar-sm p-2" />
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h5 class="fs-14 my-1 fw-medium"><a href="apps-ecommerce-seller-details.html" class="text-reset">Azak Tool</a></h5>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="<?php echo base_url('public/admn/assets/images/companies/img-3.png') ?>" alt="" class="avatar-sm p-2" />
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="<?php echo base_url('publc/admin/assets/images/companies/img-8.png') ?>" alt="" class="avatar-sm p-2" />
                                                    </div>
                                                    <div class="flex-grow-1">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="<?php echo base_url('public/admin/assets/images/companies/img-5.png') ?>" alt="" class="avatar-sm p-2" />
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h5 class="fs-14 my-1 fw-medium">
                                    ...
                                    <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="<?php echo base_url('public/admin/assets/images/users/avatar-1.jpg') ?>" alt="" class="avatar-xs rounded-circle" />
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="<?php echo base_url('public/admin/assets/images/users/avatar-2.jpg') ?>" alt="" class="avatar-xs rounded-circle" />
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="<?php echo base_url('public/admin/assets/images/users/avatar-3.jpg') ?>" alt="" class="avatar-xs rounded-circle" />
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src=<?php echo base_url('public/admin/"assets/images/users/avatar-4.jpg') ?>" alt="" class="avatar-xs rounded-circle" />
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="<?php echo base_url('public/adin/"assets/images/users/avatar-6.jpg') ?>" alt="" class="avatar-xs rounded-circle" />
                                                    </div>
