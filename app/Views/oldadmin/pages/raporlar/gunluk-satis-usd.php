                        ...
                        <div class="table-responsive table-card mb-1">
                            <table class="table table-nowrap align-middle" id="groupTable">
                                ...
                                <tr class="text-uppercase">
                                    ...
                                    <th class="sort" data-sort="id">SITE</th>
                                    <th class="sort" data-sort="customer_name">SİPARİŞ TÜRÜ</th>
                                    <th class="sort" data-sort="product_name">YILLIK FATURA TUTAR</th>
                                    <th class="sort" data-sort="date">YILLIK SİPARİŞ TUTARI</th>
                                    <th class="sort" data-sort="city">YILLIK FATURA KG</th>
                                    <th class="sort" data-sort="city">YILLIK SİPARİŞ KG</th>
                                    <th class="sort" data-sort="city">AYLIK FATURA TUTAR</th>
                                    <th class="sort" data-sort="city">AYLIK SİPARİŞ TUTAR</th>
                                    <th class="sort" data-sort="city">AYLIK FATURA KG</th>
                                    <th class="sort" data-sort="city">AYLIK SİPARİŞ KG</th>
                                    <th class="sort" data-sort="city">GÜNLÜK FATURA TUTAR</th>
                                    <th class="sort" data-sort="city">GÜNLÜK SİPARİŞ TUTAR</th>
                                    <th class="sort" data-sort="city">GÜNLÜK FATURA KG</th>
                                    <th class="sort" data-sort="city">GÜNLÜK SİPARİŞ KG</th>
                                </tr>
                                </thead>
                                ...
                                <tr>
                                    ...
                                    <td class="id"><?=  $row['SITE']; ?></td>
                                    <td class="id"><?=  $row['SIPARIS_TURU']; ?></td>
