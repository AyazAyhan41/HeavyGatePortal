...
<script>
    ...
    chartColumnDatatalabelColors && (options = {
        ...
        dataLabels: {
            enabled: !0, formatter: function (t) {
                return t + ""
            }, offsetY: -20, style: {fontSize: "12px", colors: ["#adb5bd"]}
        },

        series: [{name: "Inflation", data: [3.5, 3.2, 5, 10.1, 4.2, 3.8, 3, 2.4, 4, 1.2, 3.5, .8]}],
    ...
    chartColumnMarkersColors && (options = {
        series: [{
            ...
            data: [{
                x: "2011",
                y: 1292,
                goals: [{name: "Expected", value: 1400, strokeWidth: 5, strokeColor: "#775DD0"}]
            }, {
                x: "2012",
                y: 4432,
                goals: [{name: "Expected", value: 5400, strokeWidth: 5, strokeColor: "#775DD0"}]
            }, {
                x: "2013",
                y: 5423,
                goals: [{name: "Expected", value: 5200, strokeWidth: 5, strokeColor: "#775DD0"}]
            }, {
                x: "2014",
                y: 6653,
                goals: [{name: "Expected", value: 6500, strokeWidth: 5, strokeColor: "#775DD0"}]
            }, {
                x: "2015",
                y: 8133,
                goals: [{name: "Expected", value: 6600, strokeWidth: 5, strokeColor: "#775DD0"}]
            }, {
                x: "2016",
                y: 7132,
                goals: [{name: "Expected", value: 7500, strokeWidth: 5, strokeColor: "#775DD0"}]
            }, {
                x: "2017",
                y: 7332,
                goals: [{name: "Expected", value: 8700, strokeWidth: 5, strokeColor: "#775DD0"}]
    ...
    chartNagetiveValuesColors && (options = {
        ...
        plotOptions: {
            bar: {
                colors: {
                    ranges: [{from: -100, to: -46, color: chartNagetiveValuesColors[1]}, {
                        from: -45,
                        to: 0,
    ...
    chartRangeColors && (options = {
        series: [{
            data: [{x: "Team A", y: [1, 5]}, {x: "Team B", y: [4, 6]}, {
                x: "Team C",
                y: [5, 8]
            }, {x: "Team D", y: [3, 11]}]
        }, {
            data: [{x: "Team A", y: [2, 6]}, {x: "Team B", y: [1, 3]}, {x: "Team C", y: [7, 8]}, {
                x: "Team D",
                y: [5, 9]
            }]
        }],
    ...
    function shuffleArray(t) {
        for (var e = t.length - 1; 0 < e; e--) {
            var a = Math.floor(Math.random() * (e + 1)), r = t[e];
            t[e] = t[a], t[a] = r
        }
        return t
    }
    ...
    }, {y: 430, quarters: [{x: "Q1", y: 120}, {x: "Q2", y: 110}, {x: "Q3", y: 90}, {x: "Q4", y: 110}]}, {
        y: 448,
        quarters: [{x: "Q1", y: 70}, {x: "Q2", y: 100}, {x: "Q3", y: 140}, {x: "Q4", y: 138}]
    }, {y: 470, quarters: [{x: "Q1", y: 150}, {x: "Q2", y: 60}, {x: "Q3", y: 190}, {x: "Q4", y: 70}]}, {
        y: 540,
        quarters: [{x: "Q1", y: 120}, {x: "Q2", y: 120}, {x: "Q3", y: 130}, {x: "Q4", y: 170}]
    }, {y: 580, quarters: [{x: "Q1", y: 170}, {x: "Q2", y: 130}, {x: "Q3", y: 120}, {x: "Q4", y: 160}]}];

    function makeData() {
        var t = shuffleArray(arrayData);
        return [{x: "2011", y: t[0].y, color: colors[0], quarters: t[0].quarters}, {
            x: "2012",
            y: t[1].y,
            color: colors[1],
    ...
    function updateQuarterChart(t, e) {
        ...
        if (t.w.globals.selectedDataPoints[0]) {
            for (var o = t.w.globals.selectedDataPoints, s = 0; s < o[0].length; s++) {
                var l = o[0][s], n = t.w.config.series[0];
                a.push({name: n.data[l].x, data: n.data[l].quarters}), r.push(n.data[l].color)
            }
            return 0 === a.length && (a = [{data: []}]), ApexCharts.exec(e, "updateOptions", {
                series: a,
                colors: r,
                fill: {colors: r}
            })
    ...
    var options = {
        ...
        chart: {
            id: "barYear", height: 330, width: "100%", type: "bar", events: {
                dataPointSelection: function (t, e, a) {
                    var r = document.querySelector("#chart-quarter"), o = document.querySelector("#chart-year");
        ...
        dataLabels: {
            enabled: !0, textAnchor: "start", style: {colors: ["#fff"]}, formatter: function (t, e) {
        ...
        states: {
            ...
            active: {allowMultipleDataPointsSelection: !0, filter: {type: "darken", value: 1}}
        },
        tooltip: {
            x: {show: !1}, y: {
                title: {
    ...
    var chart, chartColumnDistributedColors = getChartColorsArray("column_distributed");
    ...
    var optionsGroup, chartGroup, chartColumnGroupLabelsColors = getChartColorsArray("column_group_labels");
    chartColumnGroupLabelsColors && (dayjs.extend(window.dayjs_plugin_quarterOfYear), optionsGroup = {
        series: [{
            name: "sales",
            data: [{x: "2020/01/01", y: 400}, {x: "2020/04/01", y: 430}, {x: "2020/07/01", y: 448}, {
                x: "2020/10/01",
                y: 470
            }, {x: "2021/01/01", y: 540}, {x: "2021/04/01", y: 580}, {x: "2021/07/01", y: 690}, {x: "2021/10/01", y: 690}]
        }],
        chart: {type: "bar", height: 350, toolbar: {show: !1}},
        ...
        xaxis: {
            ...
            group: {
                ...
                groups: [{title: "2020", cols: 4}, {title: "2021", cols: 4}]
            }
        },
